		...
		while (sc.hasNextLine()) {
			...
			if(line.length()>14) {
				char[] linearry = line.toCharArray();
			 	...
			 	String finish=line.substring(line.length()-4,line.length());
				...
				System.out.println("transmission "+ code+ " "+ error); 
				for(int e=0;e<response.size();e++) {
					System.out.print(response.get(e));
				}
				System.out.println("\n");
