...
public class Linear {
	...
	public static void main(String[] args) {
			...
			if(big_list.get(mid).get(0).equals(name)) {
				...
				if(gender2.equals("F")) {
					...
					if(temp_name.equals(name)) {
						amount2 = Integer.parseInt(big_list.get(mid+1).get(2));
						big_total=big_total+amount2;
					}
				}
		...
		System.out.println("There was "+big_total+" babies that were named "+ name+" in the year "+ year);
		System.out.println("This took "+loops +" comparisons");
